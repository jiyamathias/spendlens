...
TransactionModel _transactionModelDeserialize(
  ...
  final object = TransactionModel(
    ...
    mood: reader.readString(offsets[5]),
...
extension TransactionModelQuerySortBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy> sortByMood() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQuerySortThenBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy> thenByMood() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mood', Sort.asc);
    });
  }
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct> distinctByMood(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, String, QQueryOperations> moodProperty() {
    return QueryBuilder.apply(this, (query) {
